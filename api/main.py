...
app.include_router(collections_query.router, prefix="/api", tags=["Collections"])  # Collection query endpoint
app.include_router(collections_ingest.router, prefix="/api", tags=["Collections"])  # Collection-specific ingest
